...
/**
 * Where a part enters the catalog.
 *
  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="mx-auto flex max-w-2xl flex-col gap-6 p-6">
        <div>
          <h2 className="font-heading text-xl font-bold text-zinc-100">Match tools to a part</h2>
          <p className="mt-2 text-sm text-zinc-400">
            Upload a CAD part, select the features you want to cut, and the catalog narrows to the
            tools that can cut all of them.
          </p>
        </div>
        ...
        {session.status === 'connected' ? (
          <Card className="flex flex-col gap-4 p-6">
            ...
            <p className="text-xs text-zinc-500">
              {CAD_EXTENSIONS.join(', ')} — the file is uploaded straight to Toolpath storage, not
